...
public class DefaultIncludedBuildFactory implements IncludedBuildFactory, Stoppable {
    ...
    private void validateIncludedBuild(IncludedBuild includedBuild, SettingsInternal settings) {
        File settingsFile = findExistingSettingsFileIn(settings.getSettingsDir());
    ...
    private File findExistingSettingsFileIn(File settingsDir) {
        return buildLayoutFactory.findExistingSettingsFileIn(settingsDir);
    }
